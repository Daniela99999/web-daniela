...
<canvas  id="chart1" style=" background-color: #fdcae1;  width:100%;" height="500%" ></canvas>
<script>
...
<canvas id="chart2" style="background-color: #84b6f4; width:100%;" height="500%"></canvas>
<script>
...
<canvas id="chart3" style=" background-color: #fabfb7; width:100%;" height="500%"></canvas>
<script>
...
<canvas id="chart4" style="background-color: #b2e2f2; width:100%;" height="500%"></canvas>
<script>
